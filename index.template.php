...
<div id="header">
	...
	<div class="wrapper">
	<h1 class="forumtitle">
				<a href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? $context['forum_name'] : '<img src="' . $context['header_logo_url_html_safe'] . '" alt="' . $context['forum_name'] . '" style="height:60px"/>', '</a>
			</h1>
	', template_menu(), '
	<div id="iletim">';
		...
		if ($context['user']['is_logged'])
		{
			echo '
			<ul class="resim">
			<li><a href="' , $scripturl , '?action=profile" class="dropdown-toggle">
								...
								<span class="caret">', $context['user']['name'], '</span>
							</a>
				<ul class="pngbg">
		...
		else
		{
			echo '
				<ul>
					<li><a class="icon_login" href="', $scripturl, '?action=login">', $txt['login'], '</a></li>
	...
	<div id="footer">
			...
			<div class="wrapper">
				...
				<div class="smf_copyright">
					', !empty($settings['redalert_copyright']) ? $settings['redalert_copyright'] : $context['forum_name'] .' &copy;' ,'
			...
			echo '
				...
				<div class="silverbullets">
					Theme <a href="https://github.com/ithinkreviews/smf-red-alert-theme" title="Red Alert" target="_blank">Red Alert</a> by the <a href="https://www.ithinkreviews.com/" title="iThinkReviews" target="_blank">iThinkReviews</a> team
				</div>
